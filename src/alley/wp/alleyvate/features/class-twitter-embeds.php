...
final class Twitter_Embeds implements Feature {
	 ...
	 *
	 * @param string $url     URL of the HTTP request.
	 * @param array  $headers HTTP request headers. Ignored.
	 * @param array  $data    HTTP request data. Ignored.
	 * @param string $type    HTTP request type. Ignored.
	 * @param array  $options HTTP request options. Passed by reference.
	 */
